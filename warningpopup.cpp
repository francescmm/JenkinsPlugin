...
int WarningPopup::showPeriod() const
{
   return _showPeriod;
}

void WarningPopup::setShowPeriod(int showPeriod)
{
...
void WarningPopup::showPopup(const QString &text)
{
   ...
   {
      popupRect = QStyle::alignedRect(Qt::RightToLeft, Qt::AlignBottom, size(), activeWindow->geometry());
